...
BEGIN
    ...
    INSERT INTO tmp_epe_detail(red_group_id, upe_name, upe_vendor, upe_model, upe_port_status, epe_name, epe_vendor, epe_model, epe_card, epe_slot, epe_port, role, service_sla_slg, physical_group_slg, primary_no, epe_serial, epe_ip, epe_status, cable_name, core_no, exc_abb, zone_code, wilayah_code, region_code)
	SELECT 
			a.red_group_id, 
            a.upe_name, 
            a.upe_vendor, 
